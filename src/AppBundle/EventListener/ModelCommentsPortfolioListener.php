...
class ModelCommentsPortfolioListener implements EventSubscriberInterface
{
    /**
    ...
    /**
     * ModelCommentsPortfolioListener constructor
     *
    ...
    {
        return array(
            FormEvents::SUBMIT => 'handleModelCommentsPortfolioForm',
        );
    }

    /**
     * Handle the modelCommentsPortfolio form
     *
     * @param FormEvent $event
     */
    public function handleModelCommentsPortfolioForm(FormEvent $event)
    {
        $form = $event->getForm();

        /** @var ModelCommentsPortfolio $image */
        $image = $event->getData();
