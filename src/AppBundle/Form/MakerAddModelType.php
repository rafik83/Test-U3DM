...
class MakerAddModelType extends AbstractType
{
    /**
     * @var ModelListener
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('attachmentFile', VichFileType::class, array(
                'required' => true,
                'label'    => 'model.form.label.attachmentFile',
                'attr' => array(
                    'title'     => 'Si plusieurs fichiers 3D, ajouter les dans un fichier Zip')
            ))
            ...
            ->add('correctionReason', TextareaType::class, array(
                'label'    => 'Raison de la demande de correction',
                'required' => false,
                'disabled' => true,
                'attr'     => array('rows' => 5)
            ))
    ...
    {
        return 'appbundle_maker_add_model';
    }
}