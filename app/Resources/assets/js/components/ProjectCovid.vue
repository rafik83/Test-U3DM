<template>
	<div>   
            <div class="col-sm-9" v-if="stateProject != 'open' && projectOrigin.status < 4">
            	<div class="col-sm-3"><label for="">{{label1_1}}<i>*</i> :</label></div>
            	<div class="col-sm-9" v-if="stateProject == 'open'">
            		<input type="text" class="col-sm-12" v-model="project.name" placeholder="Saisissez votre référence" v-on:input="checkInput('name')" v-bind:class="{ errorField : fieldError['name'] }">
            	</div>
            ...
            <div class="col-sm-12" v-else>
            	<div class="col-sm-3"><label for="">{{label1_1}}<i>*</i> :</label></div>
            	<div class="col-sm-9" v-if="stateProject == 'open'">
            		<input type="text" class="col-sm-12" v-model="project.name" placeholder="Saisissez votre réference" v-on:input="checkInput('name')" v-bind:class="{ errorField : fieldError['name'] }">
            	</div>
            	<div class="col-sm-9" v-else>
            		<p>{{project.name}}</p>
            	</div>
            </div>
            <div class="col-sm-3 text-right" v-if="stateProject != 'open' && projectOrigin.status < 4">
            	
				Les devis sont attendus au plus tard <br>
				{{ expiredDate }} à 13h00
            ...
            <div class="col-sm-12">
            	...
            	<div class="col-sm-9" v-if="stateProject == 'open'">
            		<select name="projectType" id="" v-model="projectType">
            ...
            <div class="col-sm-12">
            	...
            	<div class="col-sm-9" v-if="stateProject == 'open'">
            		<textarea name="" id="" cols="30" rows="10" v-model="project.description" v-on:input="checkInput('description')" v-bind:class="{ errorField : fieldError['description'] }">
            		</textarea>
            	</div>
            	<div class="col-sm-9" v-else>
	            ...
	            <div class="col-sm-12" style="padding-top:20px;" v-if="requiredAddressBlock" >
	            	...
	            	<div class="col-sm-9" v-if="stateProject == 'open'">
	            		...
	            		<div class="col-sm-12" style="padding-left:0px !important;">
	            			...
	            			<input type="text" v-model="project.address.street2" placeholder="Complément d'adresse" maxlength="255" class="col-sm-4">
	            		</div>
	            		<div class="col-sm-12" style="padding-left:0px !important;">
	...
	export default {
		...
		methods: {
			checkFormProject(){
				...
				if(this.projectType.addressProject){
					...
					this.project.dim.x = 1;
					this.project.dim.y = 1;
					this.project.dim.z = 1;
				}			
